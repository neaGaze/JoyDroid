...
/* use to display the name, password, port and host UI in the android phone by extending  "RemotePCDroidConnEditActivity". It is extendion of ConnectionWifi.java*/
public class ConnWifiEditActivity extends ConnEditActivity
{
	/**
