...
public abstract class JoydroidAction
{
	public static final byte BUTTON = 14;
	public static final byte DIRECTION = 15;
...
*/	
	public static JoydroidAction parse(DataInputStream dis) throws IOException
	{	
...
//				return MouseWheelAction.parse(dis);
			case BUTTON:
				return ButtonAction.parse(dis);
			case DIRECTION:
				return DirectionControlAction.parse(dis);
			case AUTHENTICATION:			
